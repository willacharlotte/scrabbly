...
import { exchangeCredentialsRoute } from "../src/routes/api/credentials";
import { authenticationRoute } from "../src/routes/api/authentication";
import { usersRoute } from "../src/routes/api/users";

import verifyToken from "./middleware/verify-token";
import { boardRoute } from "../src/routes/api/board";
import { gamesRoute } from "../src/routes/api/games";
// import { credentials } from "../backend/service/middleware/credentials";
import { DbConnection } from "../src/backend/dal/db-connection";
